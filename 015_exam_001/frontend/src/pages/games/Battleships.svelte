      ...
      socket.off();
        ...
        <div id="main-battleships-div">
          ...
          {:else if clientGameState.condition === 3}
            <p>Game ready!</p>
            <p>Use the red grid to fire. Once both players have fired, the server processes it.</p>
          {:else if clientGameState.condition === 4}
          <p>OK, now we're waiting for the server to process the shot. Please stand-by for battle damage report...</p>
<!-- } -->
